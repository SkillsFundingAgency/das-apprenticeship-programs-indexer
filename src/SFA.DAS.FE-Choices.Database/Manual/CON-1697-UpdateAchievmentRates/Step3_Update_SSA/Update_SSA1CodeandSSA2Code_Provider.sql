...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Agriculture, Horticulture and Animal Care'
order by [SSA2 Code]

update [dbo].[ProviderRaw] 
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Arts, Media and Publishing' 
order by [Sector Subject Area Tier 2]

select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 2]='Publishing and Information Services'
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Business, Administration and Law' 
order by [SSA2 Code]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Construction, Planning and the Built Environment' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Education and Training' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Engineering and Manufacturing Technologies' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Health, Public Services and Care' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Information and Communication Technology' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Leisure, Travel and Tourism' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Retail and Commercial Enterprise' 
order by [Sector Subject Area Tier 2]
...
select * from [dbo].[ProviderRaw] where [Sector Subject Area Tier 1]='Science and Mathematics' 
order by [Sector Subject Area Tier 2]
